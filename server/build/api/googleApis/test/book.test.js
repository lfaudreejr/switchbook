...
describe.only('google Books Api', () => {
    describe('getBook()', () => {
        const book = googleBooks_1.getBook('Shogun', 'James Clavell');
            ...
            chai.expect(book).to.eventually.haveOwnProperty('data').that.haveOwnProperty('items').to.have.deep.members([
                {
                    ...
                    volumeInfo: {
                        ...
                        imageLinks: {
                            smallThumbnail: 'http://books.google.com/books/content?id=cWAF8_uH1_sC&printsec=frontcover&img=1&zoom=5&edge=curl&source=gbs_api',
                            thumbnail: 'http://books.google.com/books/content?id=cWAF8_uH1_sC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api'
                        }
                    }
                }
            ]);
